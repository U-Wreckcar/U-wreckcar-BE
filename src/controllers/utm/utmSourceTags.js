...
async function getUtmSources(req, res) {
    ...
    const sql_query = `SELECT source_name FROM uwreckcar_db.User_utm_sources where user_id=${user_id} order by created_at desc;`;
